...
This file provides guidance to AI coding assistants (Codex, Gemini CLI, Copilot CLI, and other tools that follow the AGENTS.md convention) when working with code in this repository.
